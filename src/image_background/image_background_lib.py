...
def get_titan_image_background_replacement_request_body(
    prompt, image_bytes, mask_prompt, negative_prompt=None, outpainting_mode="DEFAULT"
):
...
def get_image_from_model(
    ...
    )  # mask prompt "objects to keep" prompt text "description of background to add"
